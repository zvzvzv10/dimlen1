        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-[32px] shadow-lg p-8 md:p-12">
            ...
            <div className="space-y-8 text-gray-700">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-4 text-gray-900">6. Контакты</h2>
                <p className="leading-relaxed">
                  По всем вопросам, связанным с обработкой персональных данных, можно обращаться по телефону: <a href="tel:+79099089101" className="text-blue-600 hover:text-blue-700">+7 (909) 908-91-01</a> или по электронной почте: <a href="mailto:dimlen_leonid@mail.ru" className="text-blue-600 hover:text-blue-700">dimlen_leonid@mail.ru</a>
                </p>
              </section>

              <section>
                <h2 className="text-2xl font-semibold mb-4 text-gray-900">7. Изменения в политике конфиденциальности</h2>
                <p className="leading-relaxed">
