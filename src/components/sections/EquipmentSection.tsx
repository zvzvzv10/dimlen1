...
const equipmentImages: GalleryImage[] = [
  {
    src: "/images/oborudovanie/car_1.png",
    alt: "Оборудование 1",
    category: "Оборудование"
  },
  {
    src: "/images/oborudovanie/car_2.jpg",
    alt: "Оборудование 2",
    category: "Оборудование"
  },
  {
    src: "/images/oborudovanie/car_3.jpg",
    alt: "Оборудование 1",
    category: "Оборудование"
  },
  {
    src: "/images/oborudovanie/car_4.png",
    alt: "Оборудование 1",
    category: "Оборудование"
  },
  {
    src: "/images/oborudovanie/car_5.png",
    alt: "Оборудование 5",
    category: "Оборудование"
  },
  {
    src: "/images/oborudovanie/car_6.jpg",
    alt: "Оборудование 6",
    category: "Оборудование"
  }
];
...
export const EquipmentSection = () => {
  ...
  return (
    <section id="equipment" className="relative bg-gradient-to-b from-gray-50 via-white to-gray-50 py-16 md:py-24 px-4 sm:px-6 md:px-[50px] rounded-[32px] shadow-lg overflow-hidden ">
      <div className="max-w-[1400px] mx-auto">
        {/* Equipment Section */}
        <div id="equipment" className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-start mb-16 md:mb-24">
          {/* Left Content */}
        ...
        {/* Guarantee Section */}
        <div id="guarantees" className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-start">
          {/* Left Gallery */}
          <div className="w-full lg:w-1/2">
            <div className="relative rounded-[32px] overflow-hidden aspect-[4/3] shadow-xl group cursor-pointer">
              <Swiper
